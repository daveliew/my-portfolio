    ...
    <>
      ...
      <div className="print-page max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8 border-b-2 border-purple-600 pb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Vibe Coding Quick Start</h1>
          <p className="text-lg text-gray-600">Build Your Professional Brand with AI</p>
          <p className="text-sm text-purple-600 mt-2">UB/SIM Career Development Seminar</p>
        </div>
        ...
        <div className="flex items-center gap-6 mb-8 p-4 bg-gray-50 rounded-lg">
          ...
          <div>
            <p className="font-semibold text-gray-800">Scan or visit:</p>
            <p className="text-purple-600 font-mono">daveliew.com/vibe-coding</p>
            <p className="text-sm text-gray-600 mt-1">Full guide with videos and examples</p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={item.step} className="flex items-center gap-4 p-3 border border-gray-200 rounded-lg">
                <div className="flex-shrink-0 w-8 h-8 border-2 border-gray-300 rounded flex items-center justify-center font-bold text-gray-600">
                  {item.step}
                </div>
                ...
                <div className="flex-shrink-0 w-6 h-6 border-2 border-gray-300 rounded"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="font-semibold text-blue-800 mb-2">Personal Introduction Site</p>
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="font-semibold text-green-800 mb-2">Bio Refinement (Claude/ChatGPT)</p>
              <p className="text-sm text-gray-700 font-mono leading-relaxed">
            ...
            <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <p className="font-semibold text-purple-800 mb-2">Iteration Prompt</p>
              <p className="text-sm text-gray-700 font-mono leading-relaxed">
        ...
        <div className="p-6 bg-amber-50 border-2 border-amber-300 rounded-lg">
          <h2 className="text-xl font-bold text-amber-800 mb-4">📌 This Week&apos;s Action Items</h2>
          <div className="space-y-2">
            {[
              ...
              <div key={index} className="flex items-center gap-3">
                <div className="w-5 h-5 border-2 border-amber-400 rounded flex-shrink-0"></div>
      ...
      <div className="print-page max-w-4xl mx-auto px-6 py-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 border-b-2 border-gray-200 pb-4">
          Advanced Tips &amp; Next Steps
        </h2>

        {/* Writing Better Prompts */}
        <div className="mb-8">
          <h3 className="text-lg font-bold text-gray-800 mb-3">💡 Writing Better Prompts</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-red-50 border border-red-200 rounded">
              <p className="font-semibold text-red-700 text-sm mb-1">❌ Too Vague</p>
              <p className="text-xs text-gray-700">&quot;Make me a website&quot;</p>
            </div>
            <div className="p-3 bg-green-50 border border-green-200 rounded">
              <p className="font-semibold text-green-700 text-sm mb-1">✓ Specific</p>
              <p className="text-xs text-gray-700">&quot;Create a minimal personal site with blue/white colors, hero section with my name, and 3 cards for skills&quot;</p>
            </div>
          </div>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-bold text-gray-800 mb-3">🔄 Common Iteration Commands</h3>
          <div className="grid grid-cols-2 gap-2 text-sm">
            {[
              ...
              <div key={index} className="p-2 bg-gray-50 rounded font-mono text-gray-700">
                &quot;{cmd}&quot;
              </div>
            ))}
          </div>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-bold text-gray-800 mb-3">📚 4-Week No-Code AI Branding Path</h3>
          <div className="space-y-2">

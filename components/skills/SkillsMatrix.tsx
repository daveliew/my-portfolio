        ...
        <div key={categoryData.category} className="bg-gray-800 rounded-lg p-6">
          ...
          <div className="space-y-4">
            {categoryData.skills.map((skill) => (
              <div key={skill.name} className="border-l-2 border-burgundy-dark pl-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {skill.keyLearnings.map((learning: string) => (
                    <span key={learning} className="px-2 py-1 text-xs bg-gray-700 text-gray-300 rounded-md">
                      {learning}
                    </span>
                  ))}
                </div>
